...
由于某次[作业]([https://github.com/BeiYazi0/DL_homework/SP](https://github.com/BeiYazi0/DL_homework/tree/main/SP))要求不能使用框架，只好痛苦地写出了这个奇怪的东西，本 README 也是该作业 README 的一部分。
